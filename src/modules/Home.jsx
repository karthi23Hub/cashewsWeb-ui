        ...
        <div className="home-container" id="/">
            ...
            <div className="home-text-container">
                ...
                <div className="button-container" >
                   <button className="contact-button" data-aos="fade-up" data-aos-delay="80"  data-aos-duration="2500">Contact Us</button>
                   <button className="watch-more-button" data-aos="fade-up" data-aos-delay="80"  data-aos-duration="2500">Watch More</button>
                </div>
            </div>
